                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <select class="form-control @error('type') is-invalid @enderror select-2" name="type">
                                            <option value=""></option>
                                            <option value="1" @selected(old('type', $user) == 1)>Internal</option>
                                            <option value="0" @selected(old('type', $user) == 0 && is_numeric(old('type', $user)))>External</option>
                                        </select>
                                        @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
